...
from .base import SCHEMA_URL, WebhooktoFedoraMessagingMessagesMessage, THING_SCHEMA


class NewThingV1(WebhooktoFedoraMessagingMessagesMessage):
    """
    A sub-class of a Fedora message that defines a message schema for messages
    published by Webhook to Fedora Messaging Messages when a new thing is created.
    """

    topic = "webhook-to-fedora-messaging-messages.new"
