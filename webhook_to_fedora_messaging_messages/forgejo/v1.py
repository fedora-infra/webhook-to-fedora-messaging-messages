...
class ForgejoMessageV1(Webhook2FedMsgBase):
    ...
    def signature(self) -> str:
        ...
        return f"sha1={sha1(serialize_body(self.body).encode(encoding='utf-8')).hexdigest()}"  # noqa: S324

    @property
    def signature_sha256(self) -> str:
        """SHA256 signature of the request - Computed"""
        return f"sha256={sha256(serialize_body(self.body).encode(encoding='utf-8')).hexdigest()}"
