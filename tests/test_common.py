...
from webhook_to_fedora_messaging_messages_messages.thing import NewThingV1
...
def test_properties():
    ...
    assert message.app_name == "Webhook to Fedora Messaging Messages"
    assert (
        message.app_icon
        == "https://apps.fedoraproject.org/img/icons/webhook-to-fedora-messaging-messages.png"
    )
